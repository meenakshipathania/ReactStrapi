                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="appie-section-title text-center">
                                ...
                                <p>you can ask question to us.</p>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                                    ...
                                    >
                                        <div className="accrodion-inner">
                                            <div className="accrodion-title">
                                                <h4>How I can order food from website?</h4>
                                            </div>
                                            <div
                                            ...
                                            >
                                                <div className="inner">
                                                    <p>
                                                        Just go to the website, click on order
                                                        button, select menu and finally click on ok
                                                        button.
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        <div className="accrodion-inner">
                                            ...
                                            >
                                                <div className="inner">
                                                    <p>
                                                        Go to the website and click on the choose
                                                        plan option and apply for it.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div className="accrodion-inner">
                                            ...
                                            >
                                                <div className="inner">
                                                    <p>
                                                        There are various types of methods of
                                                        payments like cash on delivery, online
                                                        payment, GPay etc.
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    >
                                        <div className="accrodion-inner">
                                            <div className="accrodion-title">
                                                <h4>
                                                    After how many orders I take a membership of
                                                    Appie?
                                                </h4>
                                            </div>
                                            <div
                                            ...
                                            >
                                                <div className="inner">
                                                    <p>
                                                        You can take a membership of the restaurants
                                                        after only fifteen orders.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
