                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="appie-section-title text-center">
                                ...
                                <p>Different Offers and Plan for you.</p>
                            </div>
                            <ul
                                    ...
                                    <div className="col-lg-4 col-md-6 wow animated fadeInLeft">
                                        <div className="pricing-one__single">
                                            <div className="pricig-heading">
                                                ...
                                                <p>Get your 14 day free Order</p>
                                            </div>
                                            <div className="pricig-body">
                                                <ul>
                                                    <li>
                                                        <i className="fal fa-check" />
                                                        30-days Free Home Delivery
                                                    </li>
                                                    <li>
                                                        <i className="fal fa-check" /> 1 GB data
                                                    </li>
                                                </ul>
                                    ...
                                    <div className="col-lg-4 col-md-6 wow animated fadeInUp">
                                        <div className="pricing-one__single center">
                                            <div className="pricig-heading">
                                                ...
                                                <p>Billed $276 per Order.</p>
                                            </div>
                                            <div className="pricig-body">
                                                <ul>
                                                    <li>
                                                        <i className="fal fa-check" /> 60-days Free
                                                        Home Delivery
                                                    </li>
                                                    <li>
                                                        <i className="fal fa-check" /> Free Salad
                                                    </li>
                                                    <li>
                                                        <i className="fal fa-check" /> 1 GB Data
                                                    </li>
                                    ...
                                    <div className="col-lg-4 col-md-6 wow animated fadeInRight">
                                        <div className="pricing-one__single">
                                            <div className="pricig-heading">
                                                ...
                                                <p>Billed $300 per Order.</p>
                                            </div>
                                            <div className="pricig-body">
                                                <ul>
                                                    <li>
                                                        <i className="fal fa-check" /> 80-days Free
                                                        Delivery
                                                    </li>
                                                    <li>
                                                        <i className="fal fa-check" /> Free Salad
                                                    ...
                                                    <li>
                                                        <i className="fal fa-check" /> Free Soup
                                                        storage
                                                    </li>
                                                    <li>
                                                        <i className="fal fa-check" /> 2 GB Data for
                                                        month
                                                    </li>
                                                </ul>
                                                <div className="pricing-btn mt-35">
                                    ...
                                    <div className="col-lg-4 col-md-6 wow animated fadeInLeft">
                                        <div className="pricing-one__single">
                                            <div className="pricig-heading">
                                                ...
                                                <p>Get 30-days Free Order</p>
                                            </div>
                                            <div className="pricig-body">
                                                <ul>
                                                    <li>
                                                        <i className="fal fa-check" /> 100-days Free
                                                        Home Delivery
                                                    </li>
                                                    <li>
                                                        <i className="fal fa-check" /> 1.5 GB data
                                                    </li>
                                                </ul>
                                                <div className="pricing-btn mt-35">
                                                    <a className="main-btn" href="#">
                                    ...
                                    <div className="col-lg-4 col-md-6 wow animated fadeInUp">
                                        <div className="pricing-one__single center">
                                            <div className="pricig-heading">
                                                ...
                                                <p>Billed $276 per Order annually.</p>
                                            </div>
                                            <div className="pricig-body">
                                                <ul>
                                                    <li>
                                                        <i className="fal fa-check" /> 150-day Free
                                                        Home Delivery
                                                    </li>
                                                    <li>
                                                        <i className="fal fa-check" /> Free Soup
