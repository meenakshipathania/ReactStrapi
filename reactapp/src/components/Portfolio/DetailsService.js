                            ...
                            <div className="service-details-content">
                                ...
                                <div className="content">
                                    ...
                                    <ul className="businesslist">
                                        <li>
                                            <Link to="/portfolio/serviceRequest">
                                                {data
                                                    ? data.map((x) => (
                                                          <img
                                                              className="business"
