                            ...
                            {/* <div className="service-details-sidebar">
                                <div className="service-category-widget"> */}
                                    ...
                                    <div className='desc'>
                                        ...
                                        <p>AngularJs, Ionic Framework, HTML5, Javascript, Cordova and MongoDB on AmazonAWS</p>
                                    </div>
                                    <div className='desc'>
                                        <h4>
                                    ...
                                    <div className='desc'>
                                        ...
                                        <p>A Job Portal app for blue collar job recruiters and candidates in Dubai and UAE.</p>
                                        <p>Mehan Social Recruitment App makes recruitment for small and medium enterprises viral by offering a “bounty” for candidates who know people eligible for the job posted. The bounty is money offered by the business owner to candidates who refer candidates that have been hired.</p>
                                        <p><strong>Salient Features:</strong></p>
                                        <p>Referral System, In App Payments, Push Notifications, Employer / Job Seeker network, Job Resume Video Recorder</p>
                                    </div>
                                </div>
                            {/* </div>
                        </div> */}
