                            ...
                            {/* <div className="service-details-sidebar">
                                <div className="service-category-widget"> */}
                                    ...
                                    <div className='desc'>
                                        ...
                                        <p>An app and movement dedicated to elevating your lifestyle and keeping you in touch with all that matters within the Electronic Dance Music Culture.</p>
                                    </div>
                                </div>
                            {/* </div>
                        </div> */}
